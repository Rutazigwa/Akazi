...
*How the tables are shaped and why. Read before adding one.*
...
## 5a. Personal data, consent and the law

*Law No. 058/2021 is not a section of this document, it is most of it.*
...
## 5b. Access, authentication and the web surface

*Who may do what, and what a browser is allowed to do on their behalf.*
...
## 5c. Matching, cover and the guarantee

*The thesis, expressed as filters. Everything here is explainable on purpose.*
...
## 5d. Safeguarding and messaging

*The promises a worker is given, and what keeps them.*
...
## 5e. Knowing whether the operation is working

*Views that answer a question somebody actually asks.*
...
*Deployment, scheduled work, and the things that fail silently.*
...
## 5g. Working on this codebase

*Mistakes already made here. Each cost time; none needs repeating.*
